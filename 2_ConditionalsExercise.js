...
function exercise1(num1) {
  ...
  // equality and will return "varA and varB differ". For example, varA = 1 and varB = "1". 
  // For another example with boolean values, exercise4(0, false) would return false so the test would not pass, but at first glance 0 is a faulsy value. The reason 
  // the test fails is that varA and varB are of different data types here - number and boolean, respectively. 
  ...
  //Answer TWO: exactly follow the order and logic of the question's description
  function exercise10(num10) {
    let answer10;
    // --------------------------------------------
    // Write your code for the exercise below here:
  ...
  // A quick clarification QUESTION about exercise10: are we expected to code the logic in a classic FizzBuzz way such that any number divisible by 15 will 
  // return "Fizz Buzz"; or should we follow the order/logic exactly described in the question? For example, exercise10(30) would return "Fizz Buzz" for the 
  // classic case (answer ONE), but will return "Fizz" if we follow strictly the question description (answer TWO).
